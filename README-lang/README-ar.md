...
📦 **جاهز للاستخدام**: قم بزيارة <https://www.cok.ai.top/ar/> لبدء الاستخدام.

مصدر أوامر cok.ai يشمل اختيارات الإنترنت، مشاركات المجتمع، و [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts). سنقوم بتحديثات منتظمة لتقديم أوامر وإلهام جديد لك. لفهم كيفية استخدام cok.ai، يرجى الرجوع إلى [دليل المستخدم](https://www.cok.ai.top/ar/docs/guides/getting-started).
...
إضافة المتصفح cok.ai (ChatGPT Shortcut) تدعم Chrome و Edge مع وظائف متسقة مع الإصدار الويب ويتم تحديثها بانتظام. يمكن تنشيط الإضافة تلقائيًا أثناء تحميل صفحة ChatGPT، أو يمكنك تنشيط نافذة الإضافة عن طريق الضغط على مفتاح الاختصار `Alt+Shift+S`.
